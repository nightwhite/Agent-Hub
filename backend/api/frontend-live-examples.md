...
curl -sS -w '\nHTTP %{http_code}\n' \
  -H "Authorization: <url-encoded-kubeconfig>" \
  http://127.0.0.1:8080/api/v1/agents/fullcap-4gcjexv8
```
...
curl -sS -w '\nHTTP %{http_code}\n' \
  -H "Authorization: <url-encoded-kubeconfig>" \
  http://127.0.0.1:8080/api/v1/agents/fullcap-4gcjexv8/key
```
...
curl -sS -w '\nHTTP %{http_code}\n' -X POST \
  -H "Authorization: <url-encoded-kubeconfig>" \
  http://127.0.0.1:8080/api/v1/agents/fullcap-4gcjexv8/key/rotate
```
...
curl -sS -w '\nHTTP %{http_code}\n' -X POST \
  -H "Authorization: <url-encoded-kubeconfig>" \
  http://127.0.0.1:8080/api/v1/agents/fullcap-4gcjexv8/pause
```
...
curl -sS -w '\nHTTP %{http_code}\n' -X POST \
  -H "Authorization: <url-encoded-kubeconfig>" \
  http://127.0.0.1:8080/api/v1/agents/fullcap-4gcjexv8/run
```
